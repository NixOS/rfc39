# Taken from nixpkgs rev c60e4b45ffdffac4f53d503b47e4cce5cceb2e04
# and modified to only contain the initial team members.
/* List of NixOS maintainers.
  ...
  */
{
  # otherwise it keeps trying to delete me
  grahamc = {
